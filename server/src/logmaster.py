...
class LoggingContext(threading.local):
    ...
    defComp = "(unset)"    # By default, we don't know which system component this thread is being created to manage.
    defRole = "(unset)"    # By default, we don't know what role this thread is supposed to be playing.
